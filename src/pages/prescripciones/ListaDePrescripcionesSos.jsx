...
export const ListaDePrescripcionesSos = () => {
  let { id } = useParams();
        ...
        <TableBody>
          {prescripciones.map(
            ({
              ...
              if (TipoDeIndicacion === "Sos") {
                return (
                  <TableRow className="" hover key={Id}>
                    <TableCell> <IconosPrescripciones FormaFarmaceutica={FormaFarmaceutica} /> </TableCell>
                    <TableCell>{NombreDroga}</TableCell>
                    <TableCell>{NombreComercial}</TableCell>
                    <TableCell>{Dosis} {Unidad[1]}</TableCell>                    
                    <TableCell>{Via}</TableCell>                   
                    <TableCell>{Observaciones}</TableCell>
